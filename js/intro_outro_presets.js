...
const INTRO_OUTRO_PRESETS = {
  default: {
    ...
    // 드럼 연주 직전 준비 자세 — 드럼채가 전방-하향 30°로 드럼을 겨눔
    // J1: ±0.40 (팔을 드럼 뒤쪽으로 당겨 충돌 방지 → 첫 타격 시 앞으로 진입)
    // J4: 1.59 (팔꿈치 구부림 → 손을 높이 든 준비 자세)
    // J7: ∓0.65 (손목 각도 — 스틱 팁이 전방-하향 30°를 향함, dirSign=-1 기준)
    // J2: ±0.18 / J3: ±0.08
    frontReadyPose:[ 0.40, -0.18,  0.08, 1.59, 0, 0, -0.65,
                    -0.40,  0.18, -0.08, 1.59, 0, 0,  0.65],
  },
