...
// 하이 햇·크래쉬·라이드는 J1(후인 금지)·J5(안쪽 말림 금지) 제한(아래
// _IK_LIMITS 참고) 도입 후 사용자가 로컬에서 X·Y를 직접 넓게 재배치했다
// (사용자가 스크린샷으로 팔이 뒤로 젖혀지거나 안쪽으로 말리는 자세를
// 확인해 지적한 뒤 반대 방향으로 재조정). 단, 그 X·Y에 원래 높이(Z)를
